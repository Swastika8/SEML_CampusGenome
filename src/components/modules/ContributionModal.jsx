...
export default function ContributionModal() {
  ...
  const renderImageUpload = () => (
    <div className="w-full h-32 border-2 border-dashed border-gray-400 dark:border-gray-500/50 rounded-xl flex flex-col items-center justify-center text-gray-500 dark:text-gray-400 cursor-pointer hover:border-[#D4AF37] dark:hover:border-[#D4AF37] hover:bg-charcoal-50 dark:hover:bg-white/5 transition-colors mt-4">
      <UploadCloud size={32} className="mb-2 text-gray-400 dark:text-gray-500" />
      <span className="font-medium text-sm">Click to upload an image (Optional)</span>
        ...
        return (
          <div className="flex flex-col gap-5 animate-fade-in">
            ...
            <div className="flex flex-col">
              ...
              <input type="text" value={subject} onChange={(e) => setSubject(e.target.value)} placeholder="e.g. Data Structures" className={inputClasses} />
            </div>
            <div className="flex flex-col">
              <label className={labelClasses}>Insight / Verified Knowledge</label>
              <textarea value={insight} onChange={(e) => setInsight(e.target.value)} rows={4} placeholder="Share study tips, important topics..." className={`${inputClasses} resize-none`} />
            </div>
          </div>
        );
