...
const DEPARTMENTS = [
  'CS', 'IT', 'CS Regional', 'EnTC', 'Civil', 'Civil Regional',
  'Mechanical', 'CS - AIML', 'Electronics Engineering (VLSI Design)',
  'Applied Science and Humanities', 'MCA'
];
...
export default function AcademicsPage() {
  ...
  const renderLevel3 = () => {
    const posts = generatePosts(selectedDept, selectedYear);
    return (
